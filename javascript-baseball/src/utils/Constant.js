...
const INPUT_MESSAGE = Object.freeze({
  ...
  FINAL_COMMAND: `게임을 새로 시작하려면 ${COMMAND.REPLAY}, 종료하려면 ${COMMAND.END}를 입력하세요.\n`,
});
...
const OUTPUT_MESSAGE = Object.freeze({
  ...
  NOTHING: '낫싱',
  COMPLETE: `${GAME_RULE.COMPLETE_STRIKE_COUNT}개의 숫자를 모두 맞히셨습니다! 게임 종료`,
});
...
const ERROR_MESSAGE_USER_NUMBERS = Object.freeze({
  ...
  LENGTH: `${ERROR_MESSAGE_HEADER} 길이가 ${GAME_RULE.LENGTH}이 아닙니다.`,
});

const ERROR_MESSAGE_FINAL_COMMAND = Object.freeze({
  COMMAND: `${ERROR_MESSAGE_HEADER} ${COMMAND.REPLAY}(재시작) 또는 ${COMMAND.END}(종료)를 입력해야 합니다.`,
});
